...
public class PageUtil {
	...
	public Map<String, Integer> getPageNum(int page, int limit, int listCount) {
		...
		//게시글 데이터 계산해서 가져오기
				...
				//하단 넘버링의 기준이 10개여서 10으로 나누고 곱하는 것.
				int startPage = (((int) ((double)page / limit + 0.95)) - 1) * limit + 1;
				//하단 끝 넘버링 페이지
				int endPage = maxPage;
				//1~10페이지까지 모두 있을경우는 10을 endPage에 넣어줌. maxpage가 더 크면 10을 넣어줘.
				//여기의 10은 페이지 하단의 숫자(넘버링)을 몇개까지 띄울껀지.
