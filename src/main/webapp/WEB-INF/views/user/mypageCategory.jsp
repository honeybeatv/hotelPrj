...
<body>
	...
	<div class="col-12 d-inline-flex" style="padding-top:10px;">
		...
		<form action="./userInfoView" id="searchForm" name="searchForm" class="booking-form" method="post">
		...
		<div class="col-md-2"></div>
		<form action="./userReservationView" class="booking-form" method="post">
		<input type="hidden" id = "userno" name = "userno" value="${session_userno }">
		...
		<div class="col-md-2"></div>
		<form action="./userHostingEdit" class="booking-form" method="post">
		<input type="hidden" id = "userno" name = "userno" value="${session_userno }">
