		              ...
		              <div class="form-group">
	                    ...
	                    <select name="rtype" id="" class="form-control">
	                    	<option value="아파트" ${(rtype eq '아파트')? 'selected' : '' }>아파트</option>
		                     <option value="빌라" ${(rtype eq '빌라')? 'selected' : '' }>빌라</option>
		                     <option value="오피스텔" ${(rtype eq '오피스텔')? 'selected' : '' }>오피스텔</option>
		                     <option value="전원주택" ${(rtype eq '전원주택')? 'selected' : '' }>전원주택</option>
		                     <option value="공동주택" ${(rtype eq '공동주택')? 'selected' : '' }>공동주택</option>
		                     <option value="호텔" ${(rtype eq '호텔')? 'selected' : '' }>호텔</option>
		                     <option value="리조트" ${(rtype eq '리조트')? 'selected' : '' }>리조트</option>
		                     <option value="펜션" ${(rtype eq '펜션')? 'selected' : '' }>펜션</option>
